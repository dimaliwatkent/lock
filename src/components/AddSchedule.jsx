...
import { createSchedule, checkAvailabililty } from "../api";

const AddSchedule = ({ roomId, fetchSchedule }) => {
  ...
  const handleAddSchedule = async (e) => {
    e.preventDefault();
    try {
      const newSchedule = await createSchedule(roomId, scheduleForm);
      setScheduleForm({
        title: "",
        type: "regular",
        date: null,
      ...
      fetchSchedule();
      toast({
        description: `"${newSchedule.title}" schedule added`,
      });
    } catch (error) {
